#uses .format() method to table values neatly
#general syntax: "{format1}{format2}{format3}".format(var1, var2, var3)
#formatting string syntax: :[flags][width][.precision]
from math import pi
# String Examples
